...
|---|---|---|---|---|
| **OpenAI**<br><sub>Broad general intelligence & leading developer tools</sub> | [GPT](wiki/openai/gpt.md) <br><sub>GPT-5.6 family</sub> | [ChatGPT](https://chatgpt.com/) <br><sub>AI assistant</sub> | [Codex](wiki/openai/codex.md) <br><sub>Developer agent for software</sub> | [ChatGPT Work](https://chatgpt.com/) <br><sub>Longer tasks & deliverables</sub> |
