...
|---|---|---|---|---|
| **OpenAI**<br><sub>Broad general intelligence & leading developer tools</sub> | [GPT](wiki/openai/gpt.md) <br><sub>GPT-5.6 family</sub> | [ChatGPT](wiki/openai/chatgpt.md) <br><sub>AI assistant</sub> | [Codex](wiki/openai/codex.md) <br><sub>Developer agent for software</sub> | [ChatGPT Work](wiki/openai/chatgpt-work.md) <br><sub>Longer tasks & deliverables</sub> |
| **Anthropic**<br><sub>AI safety pioneers & agent-harness leaders</sub> | [Claude](wiki/anthropic/claude-model.md) <br><sub>Claude 5 family</sub> | [Claude](wiki/anthropic/claude.md) <br><sub>AI assistant</sub> | [Claude Code](wiki/anthropic/claude-code.md) <br><sub>Developer agent for codebases</sub> | [Claude Cowork](wiki/anthropic/claude-cowork.md) <br><sub>General work agent for teams & projects</sub> |
| **Google**<br><sub>AI + data + cloud advantage</sub> | [Gemini](wiki/google/gemini-model.md) <br><sub>Gemini 3 family</sub> | [Gemini + Search](wiki/google/gemini-search.md) <br><sub>Assistant with real-time search</sub> | [Antigravity](wiki/google/antigravity.md) <br><sub>Developer agent platform</sub> | [Gemini Spark](wiki/google/gemini-spark.md) <br><sub>General work agent, 24/7 execution</sub> |
| **xAI**<br><sub>Built for the era of agents</sub> | [Grok](wiki/xai/grok-model.md) <br><sub>Grok 4.6 family</sub> | [Grok](wiki/xai/grok.md) <br><sub>AI assistant</sub> | [Grok Build](wiki/xai/grok-build.md) <br><sub>Developer agent for complex builds</sub> | [Grok Bot](wiki/xai/grok-bot.md) <br><sub>Autonomous agent with its own computer</sub> |
| **Open Source**<br><sub>Open models, open freedom</sub> | [DeepSeek](wiki/open-source/deepseek.md) <br><sub>DeepSeek R1 family</sub> | [Open WebUI](wiki/open-source/open-webui.md) <br><sub>Self-hosted AI interface</sub> | [OpenHands](wiki/open-source/openhands.md) <br><sub>Open-source developer agent</sub> | [OpenClaw](wiki/open-source/openclaw.md) <br><sub>Self-hosted general work agent</sub> |
